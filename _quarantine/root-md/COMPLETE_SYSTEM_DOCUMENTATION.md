...
- **[ARCHITECTURE_OVERVIEW.md](docs/ARCHITECTURE_OVERVIEW.md)**: Domain structure, responsibilities, and key services
- **[SERVICE_CATALOG.md](docs/SERVICE_CATALOG.md)**: Approved services catalog and deprecation plan
- **[MULTI_TENANT_ARCHITECTURE.md](docs/MULTI_TENANT_ARCHITECTURE.md)**: Multi-tenant isolation implementation
- **[RBAC_OVERVIEW.md](docs/RBAC_OVERVIEW.md)**: Role-Based Access Control system overview
- **[API_V1_CONTRACT.md](docs/API_V1_CONTRACT.md)**: Stable API v1 contract and versioning strategy
- **[ERROR_ENVELOPE_CONTRACT.md](docs/ERROR_ENVELOPE_CONTRACT.md)**: Standardized error response format
- **[FRONTEND_ARCHITECTURE_DECISION.md](docs/FRONTEND_ARCHITECTURE_DECISION.md)**: Frontend architecture decision (React SPA)
- **[SECURITY_ENVIRONMENT_MATRIX.md](docs/SECURITY_ENVIRONMENT_MATRIX.md)**: Security configuration by environment
- **[WEBSOCKET_SECURITY_CHECKLIST.md](docs/WEBSOCKET_SECURITY_CHECKLIST.md)**: WebSocket security deployment checklist
- **[OBSERVABILITY.md](docs/OBSERVABILITY.md)**: SLO definitions and metrics collection
- **[RUNBOOK.md](docs/RUNBOOK.md)**: Troubleshooting guide for common issues
