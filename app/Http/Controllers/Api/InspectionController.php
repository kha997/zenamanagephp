...
{
    /**
     * List inspections for the current tenant.
     */
    public function index(Request $request): JsonResponse
    {
        $user = Auth::user();

        if (!$user || !$this->userHasPermission($user, 'inspection.read')) {
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        if (!$user || !$this->userHasPermission($user, 'inspection.create')) {
            return response()->json([
                'status' => 'error',
                'message' => 'Insufficient permissions to create inspections'
            ], 403);
        }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        if (!$user || !$this->userHasPermission($user, 'inspection.update')) {
            return response()->json([
                'status' => 'error',
                'message' => 'Insufficient permissions to update inspections'
            ], 403);
        }
    ...
    public function destroy(string $id): JsonResponse
    {
        ...
        if (!$user || !$this->userHasPermission($user, 'inspection.delete')) {
            return response()->json([
                'status' => 'error',
                'message' => 'Insufficient permissions to delete inspections'
            ], 403);
        }
    ...
    public function schedule(Request $request, string $id): JsonResponse
    {
        ...
        if (!$user || !$this->userHasPermission($user, 'inspection.schedule')) {
            return response()->json([
                'status' => 'error',
    ...
    public function conduct(Request $request, string $id): JsonResponse
    {
        ...
        if (!$user || !$this->userHasPermission($user, 'inspection.conduct')) {
            return response()->json([
                'status' => 'error',
    ...
    public function complete(Request $request, string $id): JsonResponse
    {
        ...
        if (!$user || !$this->userHasPermission($user, 'inspection.complete')) {
            return response()->json([
                'status' => 'error',
    ...
    /**
     * Get serialized inspection payload.
     */
