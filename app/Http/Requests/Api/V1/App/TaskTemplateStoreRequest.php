...
/**
 * TaskTemplateStoreRequest
 * 
 * Validation for creating a new task template
 */
class TaskTemplateStoreRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name.required' => 'Task template name is required.',
