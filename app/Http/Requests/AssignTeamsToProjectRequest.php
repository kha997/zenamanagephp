...
/**
 * Request validation for assigning teams to a project
 */
class AssignTeamsToProjectRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'teams.*.role' => [
                'nullable',
                'string',
                'in:contributor,reviewer,stakeholder'
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'teams.*.role.in' => 'The role must be one of: contributor, reviewer, stakeholder.',
