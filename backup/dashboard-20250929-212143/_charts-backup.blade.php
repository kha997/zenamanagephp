...
<div id="charts-section" class="grid grid-cols-1 lg:grid-cols-2 gap-6" role="img" aria-label="Dashboard charts showing signups and error rates">
    <!-- Signups Chart -->
    <div class="chart-panel bg-white rounded-lg shadow-sm border border-gray-200 p-6" aria-live="polite">
        ...
        <div id="signups-panel" class="min-h-chart h-64">
            <canvas id="chart-signups" width="100%" height="280" role="img" aria-label="New signups"></canvas>
        </div>
        <span class="panel-timestamp text-xs text-gray-400 mt-2 block"></span>
    </div>
    ...
    <div class="chart-panel bg-white rounded-lg shadow-sm border border-gray-200 p-6" aria-live="polite">
        ...
        <div id="errors-panel" class="min-h-chart h-64">
            <canvas id="chart-errors" width="100%" height="280" role="img" aria-label="Error rate"></canvas>
        </div>
        <span class="panel-timestamp text-xs text-gray-400 mt-2 block"></span>
    </div>
</div>
