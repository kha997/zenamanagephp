...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ZenaProject>
 */
class ZenaProjectFactory extends Factory
{
    protected $model = ZenaProject::class;
