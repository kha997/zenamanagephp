 ...
 * 
 * Add dual approval columns to change_orders table
 */
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('change_orders', function (Blueprint $table) {
            if (!Schema::hasColumn('change_orders', 'first_approved_by')) {
                $table->ulid('first_approved_by')->nullable()->after('updated_by');
            }
            if (!Schema::hasColumn('change_orders', 'first_approved_at')) {
                $table->timestamp('first_approved_at')->nullable()->after('first_approved_by');
            }
            if (!Schema::hasColumn('change_orders', 'second_approved_by')) {
                $table->ulid('second_approved_by')->nullable()->after('first_approved_at');
            }
            if (!Schema::hasColumn('change_orders', 'second_approved_at')) {
                $table->timestamp('second_approved_at')->nullable()->after('second_approved_by');
            }
            if (!Schema::hasColumn('change_orders', 'requires_dual_approval')) {
