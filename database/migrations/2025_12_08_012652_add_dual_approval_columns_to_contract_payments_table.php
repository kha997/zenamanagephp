 ...
 * 
 * Add dual approval columns to contract_payments table
 */
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('contract_payments', function (Blueprint $table) {
            if (!Schema::hasColumn('contract_payments', 'first_approved_by')) {
                $table->ulid('first_approved_by')->nullable()->after('updated_by');
            }
            if (!Schema::hasColumn('contract_payments', 'first_approved_at')) {
                $table->timestamp('first_approved_at')->nullable()->after('first_approved_by');
            }
            if (!Schema::hasColumn('contract_payments', 'second_approved_by')) {
                $table->ulid('second_approved_by')->nullable()->after('first_approved_at');
            }
            if (!Schema::hasColumn('contract_payments', 'second_approved_at')) {
                $table->timestamp('second_approved_at')->nullable()->after('second_approved_by');
            }
            if (!Schema::hasColumn('contract_payments', 'requires_dual_approval')) {
