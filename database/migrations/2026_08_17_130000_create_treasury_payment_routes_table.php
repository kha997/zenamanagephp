...
return new class extends Migration
{
    ...
    {
        TreasuryCheckConstraint::createTableWithChecks('treasury_payment_routes', function (Blueprint $table) {
            ...
            'tpr_amount_positive_chk' => 'total_allocated_amount > 0',
            'tpr_link_exactly_one_chk' => '(linked_financial_document_id IS NULL) != (linked_contract_payment_id IS NULL)',
            'tpr_contract_wallet_conullable_chk' => '(linked_contract_payment_id IS NOT NULL) = (expected_destination_wallet_id IS NOT NULL)',
        ]);
    }
