...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Standardized header component with RBAC, tenancy, search, and mobile support. Features role-based navigation filtering, theme toggle, tenant context, global search, mobile hamburger menu, breadcrumbs, notifications, and full accessibility support.',
      },
    },
  },
...
export const Desktop: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Header for desktop viewport. Full features including breadcrumbs and search.',
      },
    },
  },
};
...
export const LongBreadcrumbs: Story = {
  args: {
    ...
    breadcrumbs: [
      { label: 'Home', href: '/' },
      { label: 'Projects', href: '/projects' },
      { label: 'Project Detail', href: '/projects/123' },
  ...
  parameters: {
    docs: {
      description: {
        story: 'Header with long breadcrumb trail. Breadcrumbs are truncated if they exceed container width.',
      },
    },
  },
};
...
export const NoBreadcrumbs: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Header without breadcrumbs. Useful for top-level pages.',
      },
    },
  },
};
...
export const Minimal: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Minimal header with only essential elements. No navigation, breadcrumbs, or search.',
      },
    },
  },
};
