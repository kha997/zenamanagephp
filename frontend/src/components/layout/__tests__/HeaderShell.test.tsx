...
describe('HeaderShell', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render breadcrumbs', () => {
      ...
      const breadcrumbUtils = within(breadcrumbNav);
      expect(breadcrumbUtils.getByText('Home')).toBeInTheDocument();
      expect(breadcrumbUtils.getByText('Dashboard')).toBeInTheDocument();
    });
