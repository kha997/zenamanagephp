...
class FocusModeManager {
     ...
     */
    hideSecondaryKPIs() {
        const secondaryKPIs = document.querySelectorAll(
            '.kpi-strip .kpi-item:not(.primary), ' +
            '.secondary-kpis, ' +
            '.kpi-secondary, ' +
    ...
    Alpine.data('focusMode', () => ({
        ...
        closeOtherDropdowns() {
            ...
            if (userMenuComponent && userMenuComponent._x_dataStack) {
                ...
                if (headerData && headerData.notificationsOpen) {
                    headerData.notificationsOpen = false;
                }
            }
        },
