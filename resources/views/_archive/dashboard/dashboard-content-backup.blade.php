...
<div x-data="dashboardData()" x-init="initTheme()" class="space-y-8" :class="darkMode ? 'dark' : ''">
    ...
    <div x-show="!loading && !error" class="space-y-6">
                ...
                <div class="relative z-10">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-white" x-text="kpis['Active Tasks']"></p>
                ...
                <div class="relative z-10">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-white" x-text="kpis['Completed Today']"></p>
                ...
                <div class="relative z-10">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-white" x-text="kpis['Team Members']"></p>
        ...
        <div class="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
            ...
            <div class="space-y-3">
                <template x-for="activity in activity" :key="activity.id">
                    <div class="flex items-center space-x-3 p-3 bg-purple-50 border border-purple-200 rounded-lg">
                        ...
                        <div class="flex-1">
                            <p class="text-sm font-medium text-purple-900" x-text="activity.description"></p>
                            <div class="flex items-center space-x-2 mt-1">
                                <span class="text-xs text-purple-600" x-text="activity.user"></span>
                                <span class="text-xs text-purple-500">•</span>
                                <span class="text-xs text-purple-600" x-text="activity.created_at"></span>
                            </div>
                        </div>
                        <div class="flex items-center space-x-2">
