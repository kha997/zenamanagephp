        ...
        <div>
            ...
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-900">Project Management</p>
                </div>
            </div>
        </div>
        
        <div>
            <h4 class="font-medium text-gray-900 mb-4">Activity Summary</h4>
            <div class="space-y-3">
                <div class="flex justify-between">
                    <span class="text-sm text-gray-600">Projects Managed</span>
