...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Activity history for project: {{ $project['name'] ?? 'Unknown Project' }}</p>
        </div>
                ...
                @foreach($history as $entry)
                    <div class="history-item">
                        <div class="history-info">
                            <div class="history-action">{{ ucfirst($entry['action'] ?? 'Unknown Action') }}</div>
                            <div class="history-meta">
                                User ID: {{ $entry['user_id'] ?? 'Unknown' }}
                            </div>
                        </div>
