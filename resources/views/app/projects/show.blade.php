    ...
    <div class="container">
        <div class="project-detail">
            @if(isset($project))
                ...
                <div class="project-code">{{ $project['code'] ?? 'N/A' }}</div>
                ...
                <div class="project-info">
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $project['progress_pct'] ?? 0 }}%</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Budget</div>
                        <div class="info-value">${{ number_format($project['budget_actual'] ?? 0) }}</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Start Date</div>
                        <div class="info-value">{{ $project['start_date'] ?? 'Not set' }}</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">End Date</div>
                        <div class="info-value">{{ $project['end_date'] ?? 'Not set' }}</div>
                    </div>
                </div>
