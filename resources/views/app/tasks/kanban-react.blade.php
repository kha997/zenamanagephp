...
@section('title', 'Kanban Board (React)')
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6" 
                ...
                <div class="space-y-3">
                    @foreach($tasks->where('status', 'backlog') as $task)
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow cursor-move" 
                             ...
                             draggable="true"
                             @dragstart="handleDragStart($event, '{{ $task->id }}', 'backlog')"
                             @dragend="handleDragEnd($event)"
                             @mousedown="handleMouseDown($event, '{{ $task->id }}', 'backlog')">
                ...
                <div class="space-y-3">
                    @foreach($tasks->where('status', 'todo') as $task)
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow cursor-move" 
                             ...
                             data-task-id="{{ $task->id }}"
                             draggable="true"
                             @dragstart="handleDragStart($event, '{{ $task->id }}', 'todo')"
                             @dragend="handleDragEnd($event)">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <h4 class="text-sm font-medium text-gray-900">{{ $task->name }}</h4>
                ...
                <div class="space-y-3">
                    @foreach($tasks->where('status', 'in_progress') as $task)
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow cursor-move" 
                             ...
                             data-task-id="{{ $task->id }}"
                             draggable="true"
                             @dragstart="handleDragStart($event, '{{ $task->id }}', 'in_progress')"
                             @dragend="handleDragEnd($event)">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <h4 class="text-sm font-medium text-gray-900">{{ $task->name }}</h4>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4" 
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="bg-gray-100 text-gray-600 px-2 py-1 rounded-full text-sm">
                        {{ $tasks->where('status', 'blocked')->count() }}
                    </span>
                </div>
                <div class="space-y-3">
                    @foreach($tasks->where('status', 'blocked') as $task)
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow cursor-move" 
                             data-testid="kanban-task" 
                             data-task-id="{{ $task->id }}"
                             draggable="true"
                             @dragstart="handleDragStart($event, '{{ $task->id }}', 'blocked')"
                             @dragend="handleDragEnd($event)">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <h4 class="text-sm font-medium text-gray-900">{{ $task->name }}</h4>
                ...
                <div class="space-y-3">
                    @foreach($tasks->where('status', 'done') as $task)
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 hover:shadow-md transition-shadow cursor-move" 
                             ...
                             data-task-id="{{ $task->id }}"
                             draggable="true"
                             @dragstart="handleDragStart($event, '{{ $task->id }}', 'done')"
                             @dragend="handleDragEnd($event)">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <h4 class="text-sm font-medium text-gray-900">{{ $task->name }}</h4>
