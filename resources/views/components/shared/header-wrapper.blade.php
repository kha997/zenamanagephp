{{-- HeaderShell Blade Wrapper --}}
{{-- Integrates React HeaderShell component with Laravel data --}}
...
<div id="header-shell-root" 
     ...
     data-notifications="{{ json_encode($notificationData) }}"
