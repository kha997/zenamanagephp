...
@section('title', 'Subcontractor Lead Dashboard')
@section('page-title', 'Subcontractor Lead Dashboard')
@section('page-description', 'Subcontractor project management and progress tracking')
@section('user-initials', 'SC')
@section('user-name', 'Subcontractor Lead')
