...
@section('title', 'Chi tiết Tài liệu - ' . $document->title)
...
<div class="page-header">
    <div class="page-header-content">
        ...
        <div class="page-actions">
            ...
            <button class="btn btn-outline-primary" onclick="editDocument({{ $document->id }})">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <span class="info-value">v{{ $document->current_version->version_number ?? 1 }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <span class="info-value">
                                    {{ $document->current_version ? strtoupper(pathinfo($document->current_version->file_path, PATHINFO_EXTENSION)) : 'N/A' }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $document->current_version ? formatFileSize($document->current_version->file_size) : 'N/A' }}</span>
                            </div>
                        </div>
                        
                        @if($document->linked_entity_type && $document->linked_entity_id)
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <span class="info-value">
                                    @switch($document->linked_entity_type)
                                        ...
                                        @case('diary')
                                            ...
                                            @break
                                        @case('cr')
                                            <a href="/change-requests/{{ $document->linked_entity_id }}">CR: {{ $document->linked_entity->code ?? 'N/A' }}</a>
                                            @break
                                        @default
                                            Không xác định
                                    @endswitch
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                <label>Tạo bởi:</label>
                                <span class="info-value">{{ $document->creator->name ?? 'N/A' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $document->created_at ? $document->created_at->format('d/m/Y H:i') : 'N/A' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <span class="info-value">{{ $document->updated_at ? $document->updated_at->format('d/m/Y H:i') : 'N/A' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="info-item">
                                <label>Mô tả:</label>
                                <div class="info-value description-text">{{ $document->description }}</div>
                            </div>
                        </div>
                        @endif
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <button class="btn btn-outline-info" onclick="editDocument({{ $document->id }})">
                        ...
                        <button class="btn btn-outline-warning" onclick="shareDocument({{ $document->id }})">
...
function generateShareLink() {
    ...
    const shareLink = `${window.location.origin}/shared/documents/{{ $document->id }}?token=generated_token`;
...
function compareVersions(versionId) {
    ...
    window.open(`/documents/{{ $document->id }}/versions/${versionId}/compare`, '_blank');
}
