...
<head>
    ...
    @vite(['resources/css/operator.css', 'resources/js/money-format.js', 'resources/js/ai-lead-suggest.js', 'resources/js/ai-design-item-suggest.js', 'resources/js/ai-opportunity-summary.js'])
    @stack('styles')
</head>
<body>
    <a href="#main-content"
        ...
        <aside class="operator-sidebar">
            ...
            <nav class="operator-nav">
                ...
                <a href="{{ route('app.dashboard') }}"
                   class="operator-nav-link {{ request()->routeIs('app.dashboard') ? 'is-active' : '' }}">
                ...
                <span class="operator-nav-section">Tri thức</span>
                <a href="{{ route('operator.knowledge.index') }}"
                   class="operator-nav-link {{ request()->routeIs('operator.knowledge.*') ? 'is-active' : '' }}">
