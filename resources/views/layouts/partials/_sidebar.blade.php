    ...
    <div class="h-full overflow-y-auto">
        ...
        <nav class="p-3 space-y-1">
            ...
            <a href="/admin" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/dashboard') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
            ...
            <a href="/admin/tenants" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/tenants*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
            ...
            <a href="/admin/users" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/users*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
            ...
            <a href="/admin/security" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/security*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
            ...
            <a href="/admin/settings" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/settings*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
            ...
            <a href="/admin/billing" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/billing*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
            ...
            <a href="/admin/maintenance" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/maintenance*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
            ...
            <a href="/admin/alerts" 
               ...
               class="flex items-center px-3 py-2 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors {{ request()->is('admin/alerts*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : '' }}"
