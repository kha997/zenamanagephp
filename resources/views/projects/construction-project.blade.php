...
@section('title', 'Construction Project - Shopping Mall Development')
@section('page-title', 'Shopping Mall Development')
@section('page-description', 'Large shopping mall construction with retail spaces and entertainment areas')
