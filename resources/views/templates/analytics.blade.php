...
@section('page-title', 'Template Analytics')
@section('page-description', 'Analyze template performance and usage statistics')
@section('user-initials', 'TA')
@section('user-name', 'Template Analyst')
