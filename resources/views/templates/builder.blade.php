...
@section('page-title', 'Visual Template Builder')
@section('page-description', 'Create and edit project templates with visual drag-and-drop interface')
@section('user-initials', 'TB')
@section('user-name', 'Template Builder')
