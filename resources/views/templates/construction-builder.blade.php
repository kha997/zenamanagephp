...
@section('title', 'Construction Template Builder')
@section('page-title', 'Construction Template Builder')
@section('page-description', 'Create and edit construction project templates with specialized phases')
@section('user-initials', 'CB')
@section('user-name', 'Construction Builder')
