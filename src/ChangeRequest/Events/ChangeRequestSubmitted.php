...
/**
 * Event được dispatch khi một Change Request được gửi để phê duyệt
 */
class ChangeRequestSubmitted extends BaseEvent
{
    /**
     * Dữ liệu của Change Request được gửi
     * 
     * @var array
     */
     ...
     * @param string $actorId ID của người gửi
    ...
    {
        return 'ChangeRequest.ChangeRequest.Submitted';
    }
