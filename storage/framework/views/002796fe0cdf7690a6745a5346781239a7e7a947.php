<?php $__env->startSection('title', 'Invite Team Member'); ?>
<?php $__env->startSection('page-title', 'Invite Team Member'); ?>
<?php $__env->startSection('page-description', 'Add new team members and assign roles'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/team/invite.blade.php ENDPATH**/ ?>