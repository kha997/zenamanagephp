<?php $__env->startSection('title', 'Welcome to ' . $organizationName . '!'); ?>
<?php $__env->startSection('subtitle', 'Your account has been created successfully'); ?>
...
<div class="highlight-box">
    ...
    <div class="highlight-text">
        ...
        <strong>Joined:</strong> <?php echo e($user->joined_at ? $user->joined_at->format('F d, Y \a\t g:i A') : 'Just now'); ?>
...
<div class="content-section" style="text-align: center;">
    <a href="<?php echo e($dashboardUrl); ?>" class="btn" style="font-size: 16px; padding: 16px 32px;">
        🏠 Go to Dashboard
    </a>
</div>
...
<div class="content-section">
    ...
    <div style="margin-top: 16px;">
        <a href="<?php echo e(config('app.url')); ?>/support" class="btn btn-secondary" style="margin-right: 12px;">
            📞 Contact Support
        </a>
        <a href="<?php echo e(config('app.url')); ?>/docs" class="btn btn-secondary">
            📚 View Documentation
        </a>
    </div>
</div>
...
<?php echo $__env->make('emails.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/emails/welcome.blade.php ENDPATH**/ ?>