...
<div x-data="chartWidget(<?php echo e(json_encode($config)); ?>)" x-init="init()" class="bg-white rounded-lg shadow p-6">
    <!-- Chart Header -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/components/dashboard/charts/chart-widget.blade.php ENDPATH**/ ?>