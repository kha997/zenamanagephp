<?php $__env->startSection('title', __('calendar.title')); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('calendar.title')); ?></h1>
                <p class="mt-2 text-gray-600"><?php echo e(__('calendar.subtitle')); ?></p>
            </div>
            <div class="flex space-x-3">
                <button onclick="createEvent()" class="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200">
                    <i class="fas fa-plus mr-2"></i><?php echo e(__('calendar.create_event')); ?>
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 id="modal-title" class="text-lg font-semibold text-gray-900"><?php echo e(__('calendar.event_details')); ?></h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showEventModal(event) {
        ...
        document.getElementById('modal-content').innerHTML = `
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700"><?php echo e(__('calendar.title')); ?></label>
                    <p class="mt-1 text-sm text-gray-900">${event.title}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700"><?php echo e(__('calendar.start_time')); ?></label>
                    <p class="mt-1 text-sm text-gray-900">${event.start.toLocaleString()}</p>
                </div>
                ${event.end ? `
                <div>
                    <label class="block text-sm font-medium text-gray-700"><?php echo e(__('calendar.end_time')); ?></label>
                    <p class="mt-1 text-sm text-gray-900">${event.end.toLocaleString()}</p>
                </div>
                ` : ''}
                ${event.extendedProps.description ? `
                <div>
                    <label class="block text-sm font-medium text-gray-700"><?php echo e(__('calendar.description')); ?></label>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/app/calendar/index.blade.php ENDPATH**/ ?>