...
<?php $__env->startSection('page-title', 'Join Our Team'); ?>
<?php $__env->startSection('page-description', 'Complete your registration to join our organization'); ?>
    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600">
                Complete your registration to join <strong><?php echo e($invitation->organization->name); ?></strong>
            </p>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border">
            <div class="text-center mb-6">
                ...
                <p class="text-sm text-gray-600"><?php echo e($invitation->email); ?></p>
            </div>
            ...
            <div class="space-y-3 mb-6">
                ...
                <div class="flex items-center justify-between py-2 border-b border-gray-100">
                    ...
                    <span class="text-sm text-gray-900"><?php echo e($invitation->getProjectName()); ?></span>
                </div>
                <div class="flex items-center justify-between py-2 border-b border-gray-100">
                    <span class="text-sm font-medium text-gray-600">Invited by</span>
                    <span class="text-sm text-gray-900"><?php echo e($invitation->getInviterName()); ?></span>
                </div>
                <div class="flex items-center justify-between py-2">
                    <span class="text-sm font-medium text-gray-600">Expires</span>
                    <span class="text-sm text-gray-900"><?php echo e($invitation->expires_at->format('M d, Y')); ?></span>
                </div>
            </div>
            ...
            <div class="bg-blue-50 p-4 rounded-lg mb-6">
                ...
                <p class="text-sm text-blue-800"><?php echo e($invitation->message); ?></p>
            </div>
            <?php endif; ?>
        </div>
...
function acceptInvitation() {
    return {
        ...
        async submitRegistration() {
            ...
            try {
                const response = await fetch(`/invitations/accept/<?php echo e($invitation->token); ?>`, {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/invitations/accept.blade.php ENDPATH**/ ?>