...
<head>
    ...
    <title>Edit Sidebar - <?php echo e(ucwords(str_replace('_', ' ', $role))); ?> - ZENA Admin</title>
...
<body class="bg-gray-50">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('admin.sidebar-builder')); ?>" class="text-gray-500 hover:text-gray-700 mr-4">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1 class="text-2xl font-bold text-gray-900">
                            Edit Sidebar - <?php echo e(ucwords(str_replace('_', ' ', $role))); ?>

                        </h1>
                    </div>
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('admin.sidebar-builder.preview', $role)); ?>" 
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-lg shadow-sm border">
                        ...
                        <div id="sidebar-items" class="p-6 space-y-4">
                            <?php if(isset($config->config['items'])): ?>
                                <?php $__currentLoopData = $config->config['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="sidebar-item bg-gray-50 rounded-lg p-4 border" data-item-id="<?php echo e($item['id']); ?>">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    <?php if(isset($item['icon'])): ?>
                                                        <i class="fas fa-<?php echo e($item['icon']); ?> text-gray-500"></i>
                                                    <?php endif; ?>
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <label class="flex items-center">
                                                    <input type="checkbox" 
                                                           <?php echo e(($item['enabled'] ?? true) ? 'checked' : ''); ?>

                                                           onchange="toggleItem('<?php echo e($item['id']); ?>', this.checked)"
                                                ...
                                                <button onclick="deleteItem('<?php echo e($item['id']); ?>')" 
                                        ...
                                        <?php if($item['type'] === 'group' && isset($item['children'])): ?>
                                            <div class="mt-3 ml-8 space-y-2">
                                                <?php $__currentLoopData = $item['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childIndex => $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="flex items-center justify-between bg-white rounded p-2 border">
                                                        <div class="flex items-center space-x-2">
                                                            <?php if(isset($child['icon'])): ?>
                                                                <i class="fas fa-<?php echo e($child['icon']); ?> text-gray-400"></i>
                                                            <?php endif; ?>
                                                            <span class="text-sm"><?php echo e($child['label']); ?></span>
                                                        </div>
                                                        <div class="flex items-center space-x-2">
                                                            <label class="flex items-center">
                                                                <input type="checkbox" 
                                                                       <?php echo e(($child['enabled'] ?? true) ? 'checked' : ''); ?>

                                                                       onchange="toggleChildItem('<?php echo e($item['id']); ?>', '<?php echo e($child['id']); ?>', this.checked)"
                                                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                                                <span class="ml-1 text-xs text-gray-500">Enabled</span>
                                                            </label>
                                                            <button onclick="editChildItem('<?php echo e($item['id']); ?>', '<?php echo e($child['id']); ?>')" 
                    ...
                    <div class="bg-white rounded-lg shadow-sm border p-6">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium"><?php echo e(ucwords(str_replace('_', ' ', $role))); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Status:</span>
                                <span class="text-sm <?php echo e(isset($config->is_default) ? 'text-gray-500' : 'text-green-600'); ?>">
                                    <?php echo e(isset($config->is_default) ? 'Using Default' : 'Customized'); ?>

                                </span>
                            </div>
                            <?php if(!isset($config->is_default)): ?>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Version:</span>
                                    <span class="font-medium"><?php echo e($config->version ?? 1); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
    ...
    <script>
                    ...
                    <div class="mt-3">
                        ...
                        <form id="cloneForm">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="to_role" id="to_role" value="<?php echo e($role); ?>" readonly class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
                            </div>
        ...
        function performClone() {
            ...
            fetch('<?php echo e(route("admin.sidebar-builder.clone")); ?>', {
                method: 'POST',
                headers: {
        ...
        function resetToDefault() {
            if (confirm('Are you sure you want to reset to default? This will lose all customizations.')) {
                fetch('<?php echo e(route("admin.sidebar-builder.reset", $role)); ?>', {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'Accept': 'application/json',
        ...
        function exportConfig() {
            fetch('<?php echo e(route("admin.sidebar-builder.export", $role)); ?>', {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            .then(data => {
                if (data.success) {
                    ...
                    a.href = url;
                    a.download = `sidebar-config-<?php echo e($role); ?>-${new Date().toISOString().split('T')[0]}.json`;
        ...
        function performImport(config) {
            fetch('<?php echo e(route("admin.sidebar-builder.import", $role)); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
        ...
        function showPresets() {
            ...
            fetch('<?php echo e(route("admin.sidebar-builder.presets")); ?>', {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                    ...
                    <div class="mt-3">
                        ...
                        <form id="presetForm">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="role" id="role" value="<?php echo e($role); ?>" readonly class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100">
                            </div>
                            <div class="mb-4">
        ...
        function applyPreset() {
            ...
            fetch('<?php echo e(route("admin.sidebar-builder.apply-preset", $role)); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Accept': 'application/json',
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/admin/sidebar-builder-edit.blade.php ENDPATH**/ ?>