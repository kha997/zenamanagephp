    ...
    <div class="app-container">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <div class="sidebar-nav">
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('team.index')); ?>" class="nav-link <?php echo e(request()->is('team*') ? 'active' : ''); ?>">
                        <span class="nav-icon">👥</span>
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('documents.index')); ?>" class="nav-link <?php echo e(request()->is('documents*') ? 'active' : ''); ?>">
                        <span class="nav-icon">📄</span>
