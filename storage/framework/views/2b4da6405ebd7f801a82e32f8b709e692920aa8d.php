        ...
        <div class="bg-white rounded-lg shadow p-8 max-w-md w-full">
            ...
            <div class="space-y-4">
                <div class="p-4 bg-blue-50 rounded-lg">
                    ...
                    <p class="text-sm text-blue-600">Name: <?php echo e(auth()->user()->name ?? 'Not authenticated'); ?></p>
                    <p class="text-sm text-blue-600">Email: <?php echo e(auth()->user()->email ?? 'N/A'); ?></p>
                    <p class="text-sm text-blue-600">Role: <?php echo e(auth()->user()->role ?? 'N/A'); ?></p>
                </div>
                
                <div class="p-4 bg-green-50 rounded-lg">
                    <h3 class="font-semibold text-green-800">Tenant Info</h3>
                    <p class="text-sm text-green-600">Tenant: <?php echo e(auth()->user()->tenant->name ?? 'No tenant'); ?></p>
                    <p class="text-sm text-green-600">Slug: <?php echo e(auth()->user()->tenant->slug ?? 'N/A'); ?></p>
                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/_demos/test-demo.blade.php ENDPATH**/ ?>