...
<?php foreach($attributes->onlyProps(['notifications' => [], 'unreadCount' => 0]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['notifications' => [], 'unreadCount' => 0]); ?>
<?php foreach (array_filter((['notifications' => [], 'unreadCount' => 0]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
    ...
    <div x-show="isOpen" 
        ...
        <div class="px-4 py-3 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-900"><?php echo e(__('notifications.notifications')); ?></h3>
                <?php if($unreadCount > 0): ?>
        ...
        <div class="max-h-96 overflow-y-auto">
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 cursor-pointer"
                     ...
                     :class="{ 'bg-blue-50': !<?php echo e($notification->read_at ? 'true' : 'false'); ?> }">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/components/shared/notification-dropdown.blade.php ENDPATH**/ ?>