<?php $__env->startSection('title', __('templates.title')); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('templates.title')); ?></h1>
                <p class="mt-2 text-gray-600"><?php echo e(__('templates.subtitle')); ?></p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('templates.recent_templates')); ?></h2>
                ...
                <div class="p-6">
                    <div class="text-center py-8">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2"><?php echo e(__('templates.no_templates')); ?></h3>
                        <p class="text-gray-500 mb-4"><?php echo e(__('templates.no_templates_description')); ?></p>
                        <a href="/app/templates/builder" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                            ...
                            <?php echo e(__('templates.create_first_template')); ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('templates.statistics')); ?></h2>
                </div>
                <div class="p-6 space-y-4">
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600"><?php echo e(__('templates.total_templates')); ?></span>
                        <span class="font-semibold text-gray-900">0</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600"><?php echo e(__('templates.active_templates')); ?></span>
                        <span class="font-semibold text-gray-900">0</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600"><?php echo e(__('templates.templates_used')); ?></span>
                        <span class="font-semibold text-gray-900">0</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-600"><?php echo e(__('templates.last_used')); ?></span>
                        <span class="font-semibold text-gray-900"><?php echo e(__('templates.never')); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('templates.quick_actions')); ?></h2>
                </div>
                <div class="p-6 space-y-3">
                    <a href="/app/templates/builder" class="w-full flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                        ...
                        <span class="font-medium text-blue-900"><?php echo e(__('templates.create_template')); ?></span>
                    </a>
                    <a href="/app/templates/library" class="w-full flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
                        ...
                        <span class="font-medium text-green-900"><?php echo e(__('templates.browse_library')); ?></span>
                    </a>
                    <button onclick="importTemplate()" class="w-full flex items-center p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors">
                        ...
                        <span class="font-medium text-purple-900"><?php echo e(__('templates.import_template')); ?></span>
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('templates.categories')); ?></h2>
                </div>
                <div class="p-6">
                    <div class="space-y-2">
                        <button onclick="filterByCategory('all')" class="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                            <?php echo e(__('templates.all_templates')); ?> (0)
                        </button>
                        ...
                        <button onclick="filterByCategory('document')" class="w-full text-left px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-lg">
                            <?php echo e(__('templates.document_templates')); ?> (0)
                        </button>
                    </div>
                </div>
            </div>
    ...
    if (confirm('Are you sure you want to use this template?')) {
        ...
        .then(data => {
            if (data.success) {
                ...
                window.location.href = '<?php echo e(route("app.projects.index")); ?>';
            } else {
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/app/templates/index.blade.php ENDPATH**/ ?>