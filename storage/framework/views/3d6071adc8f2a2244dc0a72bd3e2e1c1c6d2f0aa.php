        ...
        <div x-show="menuOpen" 
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
                    <i class="<?php echo e($action['icon']); ?> text-gray-600"></i>
                </div>
            </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/components/shared/mobile-fab.blade.php ENDPATH**/ ?>