...
<div>
    ...
    <nav class="sidebar-nav">
        <?php if(isset($sidebarConfig['items']) && !empty($sidebarConfig['items'])): ?>
            <?php $__currentLoopData = $sidebarConfig['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($item['type'] === 'group'): ?>
                    <!-- Group Item -->
                    <div class="<?php echo e($getItemClasses($item)); ?>">
                        <div class="sidebar-group-header group" onclick="toggleGroup('<?php echo e($item['id']); ?>')">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <?php if(isset($item['icon'])): ?>
                                        <i class="<?php echo e($getIconClass($item)); ?> mr-3 text-gray-400"></i>
                                    <?php endif; ?>
                                    <span class="font-medium text-gray-700"><?php echo e($item['label']); ?></span>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <button onclick="event.stopPropagation(); togglePin('<?php echo e($item['id']); ?>')" 
                                    ...
                                    <i class="fas fa-chevron-down text-xs text-gray-400 transition-transform duration-200" id="chevron-<?php echo e($item['id']); ?>"></i>
                                </div>
                            </div>
                        </div>
                        
                        <?php if($hasChildren($item)): ?>
                            <div class="sidebar-group-children" id="group-<?php echo e($item['id']); ?>" style="display: none;">
                                <?php $__currentLoopData = $item['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e($buildUrl($child)); ?>" 
                                       class="sidebar-child-item <?php echo e($isUrlActive($buildUrl($child)) ? 'active' : ''); ?>">
                                        <?php if(isset($child['icon'])): ?>
                                            <i class="<?php echo e($getIconClass($child)); ?> mr-3 text-gray-400"></i>
                                        <?php endif; ?>
                                        <span><?php echo e($child['label']); ?></span>
                                        <?php if($child['type'] === 'external'): ?>
                ...
                <?php elseif($item['type'] === 'link'): ?>
                    ...
                    <div class="sidebar-item-wrapper group">
                        <a href="<?php echo e($buildUrl($item)); ?>" 
                           class="<?php echo e($getItemClasses($item)); ?> <?php echo e($isUrlActive($buildUrl($item)) ? 'active' : ''); ?>">
                            <?php if(isset($item['icon'])): ?>
                                <i class="<?php echo e($getIconClass($item)); ?> mr-3 text-gray-400"></i>
                            <?php endif; ?>
                            <span><?php echo e($item['label']); ?></span>
                            <?php if($shouldShowBadge($item)): ?>
                                <span class="sidebar-badge" id="badge-<?php echo e($item['id']); ?>"><?php echo e($getBadgeCount($item)); ?></span>
                            <?php endif; ?>
                        </a>
                        <button onclick="togglePin('<?php echo e($item['id']); ?>')" 
                ...
                <?php elseif($item['type'] === 'external'): ?>
                    ...
                    <a href="<?php echo e($buildUrl($item)); ?>" 
                       ...
                       class="<?php echo e($getItemClasses($item)); ?>">
                        <?php if(isset($item['icon'])): ?>
                            <i class="<?php echo e($getIconClass($item)); ?> mr-3 text-gray-400"></i>
                        <?php endif; ?>
                        <span><?php echo e($item['label']); ?></span>
        ...
        <?php else: ?>
            ...
            <div class="sidebar-item">
                <a href="/dashboard" class="<?php echo e($isUrlActive('/dashboard') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <?php if($currentRole): ?>
            <div class="text-xs text-gray-500 text-center">
                Role: <?php echo e(ucwords(str_replace('_', ' ', $currentRole))); ?>
...
</script><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/components/shared/navigation/sidebar.blade.php ENDPATH**/ ?>