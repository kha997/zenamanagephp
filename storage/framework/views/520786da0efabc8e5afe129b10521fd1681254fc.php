...
<div class="congrats-component" x-data="rewards()">
    ...
    <button @click="toggle()" 
        ...
        <span class="hidden sm:inline"><?php echo e(__('app.rewards')); ?></span>
        
        <span class="sm:hidden" x-show="isActive"><?php echo e(__('app.on')); ?></span>
    </button>
    ...
    <div x-show="isActive" 
        ...
        <div class="flex items-center space-x-2 mb-2">
            ...
            <span class="text-sm font-medium text-gray-900"><?php echo e(__('app.rewards_active')); ?></span>
        </div>
        
        <p class="text-xs text-gray-600 mb-3">
            <?php echo e(__('app.rewards_description')); ?>
        ...
        <div class="flex items-center justify-between">
            <button @click="toggle()" 
                ...
                <?php echo e(__('app.disable_rewards')); ?>

            </button>
            
            <div class="flex items-center space-x-1 text-xs text-gray-500">
                <i class="fas fa-gift"></i>
                <span><?php echo e(__('app.celebrations')); ?></span>
            </div>
        </div>
    </div>
</div>
...
<template id="congrats-template">
    <div class="congrats-message-overlay">
        <div class="congrats-message">
            ...
            <h2 class="congrats-title"><?php echo e(__('app.congratulations')); ?></h2>
            <p class="congrats-message-text"><?php echo e(__('app.great_job_task_completed')); ?></p>
            <p class="congrats-subtitle"><?php echo e(__('app.keep_up_great_work')); ?></p>
        </div>
    </div>
</template>
...
<div class="rewards-disabled text-xs text-gray-500 px-2 py-1">
    ...
    <?php echo e(__('app.feature_disabled')); ?>

</div>
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/components/shared/congrats.blade.php ENDPATH**/ ?>