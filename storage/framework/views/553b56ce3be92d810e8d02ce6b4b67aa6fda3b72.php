<?php $__env->startSection('title', 'QC Inspector Dashboard'); ?>
<?php $__env->startSection('page-title', 'QC Inspector Dashboard'); ?>
<?php $__env->startSection('page-description', 'Quality control and inspection management'); ?>
<?php $__env->startSection('user-initials', 'QC'); ?>
<?php $__env->startSection('user-name', 'QC Inspector'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/dashboards/qc-inspector.blade.php ENDPATH**/ ?>