<?php $__env->startSection('title', 'Design Project - Office Building Complex'); ?>
<?php $__env->startSection('page-title', 'Office Building Complex'); ?>
<?php $__env->startSection('page-description', 'Modern office building design project with 20 floors'); ?>
...
<?php echo $__env->make('layouts.project-detail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/projects/design-project.blade.php ENDPATH**/ ?>