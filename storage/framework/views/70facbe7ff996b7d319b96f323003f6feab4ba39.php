...
<div class="focus-mode-toggle" x-data="focusMode()">
    <button @click="toggle()" 
        ...
        <span class="hidden sm:inline"><?php echo e(__('app.focus_mode')); ?></span>
        
        <span class="sm:hidden" x-show="isActive"><?php echo e(__('app.focus')); ?></span>
    </button>
    ...
    <div x-show="isActive" 
        ...
        <div class="flex items-center space-x-2 mb-2">
            ...
            <span class="text-sm font-medium text-gray-900"><?php echo e(__('app.focus_mode_active')); ?></span>
        </div>
        
        <p class="text-xs text-gray-600 mb-3">
            <?php echo e(__('app.focus_mode_description')); ?>
        ...
        <div class="flex items-center justify-between">
            <button @click="toggle()" 
                ...
                <?php echo e(__('app.exit_focus_mode')); ?>

            </button>
            
            <div class="flex items-center space-x-1 text-xs text-gray-500">
                <i class="fas fa-info-circle"></i>
                <span><?php echo e(__('app.minimal_ui')); ?></span>
            </div>
        </div>
    </div>
</div>
...
<?php endif; ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/components/shared/focus-toggle.blade.php ENDPATH**/ ?>