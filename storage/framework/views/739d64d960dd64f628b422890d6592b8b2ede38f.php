...
<div class="p-6">
    ...
    <!-- Pagination -->
    <div class="mt-6">
        <?php echo $__env->make('admin.security._pagination', ['panel' => 'mfa'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>


<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/admin/security/_panels/mfa_adoption.blade.php ENDPATH**/ ?>