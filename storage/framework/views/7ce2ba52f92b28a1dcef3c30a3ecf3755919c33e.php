<?php $__env->startSection('title', 'Manage Invitations'); ?>
<?php $__env->startSection('page-title', 'Manage Invitations'); ?>
<?php $__env->startSection('page-description', 'Advanced invitation management for administrators'); ?>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" value="<?php echo e($invitation->id); ?>" class="invitation-checkbox rounded">
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <div class="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center">
                                        <span class="text-sm font-medium text-gray-700">
                                            <?php echo e(strtoupper(substr($invitation->email, 0, 2))); ?>
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">
                                        <?php echo e($invitation->full_name ?: $invitation->email); ?>

                                    </div>
                                    <div class="text-sm text-gray-500"><?php echo e($invitation->email); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <?php echo e($invitation->getRoleDisplayName()); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($invitation->getProjectName()); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($invitation->getInviterName()); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($invitation->expires_at->format('M d, Y')); ?>

                            <?php if($invitation->status === 'pending'): ?>
                                <div class="text-xs text-gray-500">
                                    <?php echo e($invitation->days_until_expiry); ?> days left
                                </div>
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <?php if($invitation->status === 'pending'): ?>
                                    <button 
                                        @click="resendInvitation(<?php echo e($invitation->id); ?>)"
                                    ...
                                    <button 
                                        @click="cancelInvitation(<?php echo e($invitation->id); ?>)"
                                        class="px-3 py-1 bg-gray-200 text-gray-700 rounded text-sm hover:bg-gray-300 transition-colors"
                                ...
                                <?php endif; ?>
                                <button 
                                    @click="viewInvitation(<?php echo e($invitation->id); ?>)"
                                    class="px-3 py-1 bg-gray-200 text-gray-700 rounded text-sm hover:bg-gray-300 transition-colors"
                                    title="View Details"
                                >
...
function invitationManagement() {
    return {
        ...
        selectedInvitations: [],
        stats: {
            pending: <?php echo e($invitations->where('status', 'pending')->count()); ?>,
            accepted: <?php echo e($invitations->where('status', 'accepted')->count()); ?>,
            expired: <?php echo e($invitations->where('status', 'expired')->count()); ?>,
            cancelled: <?php echo e($invitations->where('status', 'cancelled')->count()); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/invitations/manage.blade.php ENDPATH**/ ?>