<?php $__env->startSection('title', 'Project Documents'); ?>
<?php $__env->startSection('page-title', 'Project Documents'); ?>
<?php $__env->startSection('page-description', 'Manage project documents and files'); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/projects/documents.blade.php ENDPATH**/ ?>