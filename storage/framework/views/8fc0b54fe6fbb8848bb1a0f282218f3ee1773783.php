...
<?php $__env->startSection('page-description', 'Update project details and information'); ?>
    ...
    <div class="dashboard-card p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
            ...
            <div class="flex items-center">
                ...
                <span class="ml-2 font-medium"><?php echo e($users->where('id', $projectData->pm_id)->first()->name ?? 'John Smith'); ?></span>
            </div>
        </div>
    </div>
...
function editProject() {
    return {
        ...
        newTag: '',
        formData: {
            id: <?php echo e($projectData->id ?? 1); ?>,
            code: '<?php echo e($projectData->code ?? "PROJ-001"); ?>',
            name: '<?php echo e($projectData->name ?? "Sample Project"); ?>',
            description: '<?php echo e($projectData->description ?? ""); ?>',
            client_id: <?php echo e($projectData->client_id ?? 1); ?>,
            pm_id: <?php echo e($projectData->pm_id ?? 2); ?>,
            status: '<?php echo e($projectData->status ?? "active"); ?>',
            start_date: '<?php echo e($projectData->start_date ?? ""); ?>',
            end_date: '<?php echo e($projectData->end_date ?? ""); ?>',
            budget_total: <?php echo e($projectData->budget_total ?? 0); ?>,
            progress: <?php echo e($projectData->progress ?? 0); ?>,
            tags: <?php echo json_encode($projectData->tags ?? [], 15, 512) ?>
        },
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/projects/edit.blade.php ENDPATH**/ ?>