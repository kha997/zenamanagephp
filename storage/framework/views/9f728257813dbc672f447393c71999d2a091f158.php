<?php $__env->startSection('title', 'Verify Email - ZenaManage'); ?>
            ...
            <div class="bg-white shadow rounded-lg p-6">
                <div class="text-center">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="text-center">
                            <a href="<?php echo e(route('logout')); ?>" class="text-sm text-gray-600 hover:text-gray-900">
...
<?php echo $__env->make('layouts.auth-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/auth/verify-email.blade.php ENDPATH**/ ?>