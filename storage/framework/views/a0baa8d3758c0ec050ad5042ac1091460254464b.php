...
<body>
    ...
    <div class="content">
        ...
        <div class="warning">
            <strong>Important:</strong> This verification link will expire in <?php echo e($expiryHours); ?> hours for security reasons.
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/emails/verify-email.blade.php ENDPATH**/ ?>