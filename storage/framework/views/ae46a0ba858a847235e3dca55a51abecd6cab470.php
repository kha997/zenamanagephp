    ...
    <div class="h-full overflow-y-auto">
        ...
        <nav class="p-4 space-y-2">
            ...
            <a href="/admin/dashboard" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/dashboard') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
            ...
            <a href="/admin/tenants" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/tenants*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
            ...
            <!-- Users -->
            <a href="/admin/users" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/users*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
            ...
            <a href="/admin/security" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/security*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
            ...
            <a href="/admin/settings" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/settings*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
            ...
            <a href="/admin/billing" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/billing*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
            ...
            <a href="/admin/maintenance" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/maintenance*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
            ...
            <!-- Alerts -->
            <a href="/admin/alerts" 
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?php echo e(request()->is('admin/alerts*') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-700' : ''); ?>"
