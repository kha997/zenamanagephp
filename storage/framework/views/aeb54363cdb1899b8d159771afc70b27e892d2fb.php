<?php $__env->startSection('title', isset($project) ? 'Chỉnh sửa Dự án' : 'Tạo Dự án Mới'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div class="page-header-content">
        <h1 class="page-title"><?php echo e(isset($project) ? 'Chỉnh sửa Dự án' : 'Tạo Dự án Mới'); ?></h1>
...
<div class="content-wrapper">
    <form id="project-form" class="needs-validation" novalidate>
        <?php if(isset($project)): ?>
            <input type="hidden" id="project-id" value="<?php echo e($project->id); ?>">
        <?php endif; ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" required
                                           value="<?php echo e(isset($project) ? $project->name : ''); ?>">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4"
                                              placeholder="Mô tả chi tiết về dự án..."><?php echo e(isset($project) ? $project->description : ''); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="start_date" name="start_date" required
                                           value="<?php echo e(isset($project) ? $project->start_date : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="end_date" name="end_date" required
                                           value="<?php echo e(isset($project) ? $project->end_date : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        <option value="planning" <?php echo e((isset($project) && $project->status === 'planning') ? 'selected' : ''); ?>>Lập kế hoạch</option>
                                        <option value="active" <?php echo e((isset($project) && $project->status === 'active') ? 'selected' : ''); ?>>Đang thực hiện</option>
                                        <option value="on_hold" <?php echo e((isset($project) && $project->status === 'on_hold') ? 'selected' : ''); ?>>Tạm dừng</option>
                                        <option value="completed" <?php echo e((isset($project) && $project->status === 'completed') ? 'selected' : ''); ?>>Hoàn thành</option>
                                        <option value="cancelled" <?php echo e((isset($project) && $project->status === 'cancelled') ? 'selected' : ''); ?>>Đã hủy</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="planned_cost" name="planned_cost" 
                                               step="0.01" min="0" value="<?php echo e(isset($project) ? $project->planned_cost : ''); ?>">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="stat-item">
                            <label>Tiến độ:</label>
                            <div class="progress">
                                <div class="progress-bar" style="width: <?php echo e($project->progress); ?>%"></div>
                            </div>
                            <span class="stat-value"><?php echo e($project->progress); ?>%</span>
                        </div>
                        
                        <div class="stat-item">
                            <label>Chi phí thực tế:</label>
                            <span class="stat-value"><?php echo e(number_format($project->actual_cost)); ?> VNĐ</span>
                        </div>
                        
                        <div class="stat-item">
                            <label>Số lượng task:</label>
                            <span class="stat-value"><?php echo e($project->tasks_count ?? 0); ?></span>
                        </div>
                        
                        <div class="stat-item">
                            <label>Số lượng component:</label>
                            <span class="stat-value"><?php echo e($project->components_count ?? 0); ?></span>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="icon-save"></i> <?php echo e(isset($project) ? 'Cập nhật' : 'Tạo dự án'); ?>

                            </button>
                            
                            <?php if(isset($project)): ?>
                            <button type="button" class="btn btn-outline-info" onclick="viewProject(<?php echo e($project->id); ?>)">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/projects/form.blade.php ENDPATH**/ ?>