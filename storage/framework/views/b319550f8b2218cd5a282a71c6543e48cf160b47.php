<?php $__env->startSection('title', isset($task) ? 'Chỉnh sửa Công việc' : 'Tạo Công việc mới'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div class="page-header-content">
        <h1 class="page-title"><?php echo e(isset($task) ? 'Chỉnh sửa Công việc' : 'Tạo Công việc mới'); ?></h1>
            ...
            <div class="card">
                <div class="card-body">
                    <button type="button" class="btn btn-primary btn-block" onclick="saveTask()">
                        <i class="icon-save"></i> <?php echo e(isset($task) ? 'Cập nhật' : 'Tạo mới'); ?>
...
class TaskFormManager {
    constructor() {
        this.taskId = <?php echo e(isset($task) ? $task->id : 'null'); ?>;
        this.assignments = [];
        this.loadProjects();
        this.loadUsers();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/tasks/form.blade.php ENDPATH**/ ?>