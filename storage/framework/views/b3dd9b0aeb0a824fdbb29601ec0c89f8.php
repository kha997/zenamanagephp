        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600">Welcome back, <?php echo e(Auth::user()->name ?? 'User'); ?></p>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    <a href="<?php echo e(route('app.projects.create')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium">
                ...
                <div class="p-6">
                    <?php $__empty_1 = true; $__currentLoopData = $recentProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg mb-3">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <h4 class="text-sm font-medium text-gray-900"><?php echo e($project->name); ?></h4>
                                    <p class="text-xs text-gray-500"><?php echo e(ucfirst($project->status)); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
                                <p class="text-sm text-gray-900"><?php echo e($project->progress); ?>%</p>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-8">
                            ...
                            <a href="<?php echo e(route('app.projects.create')); ?>" class="text-blue-600 hover:text-blue-800 font-medium">Create your first project</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-start space-x-3 mb-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900"><?php echo e($activity->message); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(\Carbon\Carbon::parse($activity->created_at)->diffForHumans()); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-8">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0">
                                    <div class="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center">
                                        <span class="text-sm font-medium text-gray-600"><?php echo e(substr($member['name'], 0, 1)); ?></span>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="w-2 h-2 rounded-full <?php echo e($member['status_color']); ?>"></div>
                                <span class="text-xs text-gray-500"><?php echo e(ucfirst($member['status'])); ?></span>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-8">
...
window.dashboardBootstrap = <?php echo $dashboardBootstrap; ?>;
