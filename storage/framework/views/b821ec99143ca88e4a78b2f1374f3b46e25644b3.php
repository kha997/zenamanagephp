                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Tenant -->
                                <div>
                                    <label for="edit-tenant" class="block text-sm font-medium text-gray-700">Tenant</label>
                                    <select id="edit-tenant"
                                            x-model="currentUser.tenantId"
                                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/admin/users/_edit_modal.blade.php ENDPATH**/ ?>