                ...
                <template x-for="tenant in filteredTenants" :key="tenant.id">
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="text-sm text-gray-500">ID: <span x-text="tenant.id"></span></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-500" x-text="tenant.ownerEmail"></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900" x-text="tenant.users"></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500" x-text="tenant.lastActive"></td>
