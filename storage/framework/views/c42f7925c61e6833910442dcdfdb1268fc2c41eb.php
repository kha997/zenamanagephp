<?php $__env->startSection('title', isset($document) ? 'Chỉnh sửa Tài liệu' : 'Upload Tài liệu Mới'); ?>

<?php $__env->startSection('content'); ?>
<div class="page-header">
    <div class="page-header-content">
        <h1 class="page-title"><?php echo e(isset($document) ? 'Chỉnh sửa Tài liệu' : 'Upload Tài liệu Mới'); ?></h1>
...
<div class="content-wrapper">
    <form id="document-form" class="needs-validation" novalidate enctype="multipart/form-data">
        <?php if(isset($document)): ?>
            <input type="hidden" id="document-id" value="<?php echo e($document->id); ?>">
        <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="linked_entity_type" name="linked_entity_type">
                                        ...
                                        <option value="task" <?php echo e((isset($document) && $document->linked_entity_type === 'task') ? 'selected' : ''); ?>>Công việc</option>
                                        <option value="diary" <?php echo e((isset($document) && $document->linked_entity_type === 'diary') ? 'selected' : ''); ?>>Nhật ký</option>
                                        <option value="cr" <?php echo e((isset($document) && $document->linked_entity_type === 'cr') ? 'selected' : ''); ?>>Yêu cầu thay đổi</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3"
                                              placeholder="Mô tả chi tiết về tài liệu..."><?php echo e(isset($document) ? $document->description : ''); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="stat-item">
                            ...
                            <span class="stat-value">v<?php echo e($document->current_version->version_number ?? 1); ?></span>
                        </div>
                        
                        <div class="stat-item">
                            <label>Kích thước:</label>
                            <span class="stat-value"><?php echo e($document->current_version ? formatFileSize($document->current_version->file_size) : 'N/A'); ?></span>
                        </div>
                        
                        <div class="stat-item">
                            <label>Định dạng:</label>
                            <span class="stat-value"><?php echo e($document->current_version ? strtoupper(pathinfo($document->current_version->file_path, PATHINFO_EXTENSION)) : 'N/A'); ?></span>
                        </div>
                        
                        <div class="stat-item">
                            <label>Tạo bởi:</label>
                            <span class="stat-value"><?php echo e($document->creator->name ?? 'N/A'); ?></span>
                        </div>
                        
                        <div class="stat-item">
                            <label>Ngày tạo:</label>
                            <span class="stat-value"><?php echo e($document->created_at ? $document->created_at->format('d/m/Y H:i') : 'N/A'); ?></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="icon-upload"></i> <?php echo e(isset($document) ? 'Cập nhật' : 'Upload tài liệu'); ?>

                            </button>
                            
                            <?php if(isset($document)): ?>
                            <button type="button" class="btn btn-outline-info" onclick="downloadDocument(<?php echo e($document->id); ?>)">
                                <i class="icon-download"></i> Tải xuống
                            </button>
                            
                            <button type="button" class="btn btn-outline-secondary" onclick="viewDocument(<?php echo e($document->id); ?>)">
                                <i class="icon-eye"></i> Xem chi tiết
                            </button>
                            
                            <button type="button" class="btn btn-outline-danger" onclick="deleteDocument(<?php echo e($document->id); ?>)">
        ...
        try {
            ...
            if (response.status === 'success') {
                ...
                response.data.data.forEach(project => {
                    ...
                    <?php if(isset($document)): ?>
                    if (project.id === <?php echo e($document->project_id); ?>) {
        ...
        try {
            ...
            if (response.status === 'success') {
                response.data.data.forEach(item => {
                    ...
                    <?php if(isset($document)): ?>
                    if (item.id === <?php echo e($document->linked_entity_id ?? 'null'); ?>) {
                        option.selected = true;
                    }
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/documents/form.blade.php ENDPATH**/ ?>