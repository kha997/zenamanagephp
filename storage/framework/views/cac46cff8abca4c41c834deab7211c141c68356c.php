            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900"><?php echo $__env->yieldContent('page-title'); ?></h1>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-semibold">
                                <?php echo $__env->yieldContent('user-initials'); ?>
                            </div>
                            <div>
                                <div class="text-sm font-medium text-gray-900"><?php echo $__env->yieldContent('user-name'); ?></div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/layouts/project-detail.blade.php ENDPATH**/ ?>