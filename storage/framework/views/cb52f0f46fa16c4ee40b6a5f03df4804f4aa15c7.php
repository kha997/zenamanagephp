...
<div class="p-6">
    ...
    <!-- Pagination -->
    <div class="mt-6">
        <?php echo $__env->make('admin.security._pagination', ['panel' => 'keys'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
</div>


<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/admin/security/_panels/api_keys.blade.php ENDPATH**/ ?>