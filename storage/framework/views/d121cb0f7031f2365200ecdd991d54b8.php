...
<div class="min-h-screen bg-gray-50" x-data="taskManagement()" data-testid="tasks-page">
            ...
            <div class="flex justify-between items-center py-6">
                ...
                <div class="flex space-x-3">
                    ...
                    <div class="flex bg-gray-100 rounded-lg p-1">
                        ...
                        <a href="<?php echo e(route('app.tasks.kanban')); ?>" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900"><?php echo e($stats['done'] ?? 0); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900"><?php echo e($stats['overdue'] ?? 0); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow rounded-lg" data-testid="tasks-table">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 cursor-pointer" 
                            ...
                            @click="openTask('<?php echo e($task->id); ?>')"
                            @keyup.enter="openTask('<?php echo e($task->id); ?>')"
                            role="link"
                            tabindex="0">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">
                                            <a href="<?php echo e(route('app.tasks.show', $task->id)); ?>" 
                                               class="hover:text-blue-600" 
                                               data-testid="task-name-link"><?php echo e($task->name); ?></a>
                                        </div>
                                        <?php if($task->description): ?>
                                        <div class="text-sm text-gray-500 truncate max-w-xs"><?php echo e($task->description); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($task->project->name ?? 'N/A'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                    ...
                                    <?php elseif($task->status === 'blocked'): ?> bg-red-100 text-red-800
                                    <?php elseif($task->status === 'backlog'): ?> bg-gray-100 text-gray-800
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900"><?php echo e($task->assignee->name ?? 'Unassigned'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <?php if($task->end_date): ?>
                                        <?php echo e(\Carbon\Carbon::parse($task->end_date)->format('M d, Y')); ?>
                                ...
                                <div class="flex items-center">
                                    <div class="w-full bg-gray-200 rounded-full h-2 mr-2">
                                        <div class="bg-blue-600 h-2 rounded-full" 
                                             style="width: <?php echo e($task->progress_percent ?? 0); ?>%"></div>
                                    </div>
                                    <span class="text-sm text-gray-600"><?php echo e($task->progress_percent ?? 0); ?>%</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center space-x-2">
                                    <a href="<?php echo e(route('app.tasks.edit', $task->id)); ?>" 
                                       class="text-blue-600 hover:text-blue-900"
                                       data-testid="edit-task-button">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button @click="deleteTask('<?php echo e($task->id); ?>')" 
            ...
            <!-- Pagination -->
            <?php if(isset($meta) && $meta['last_page'] > 1): ?>
            <div class="px-6 py-4 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Showing <?php echo e($meta['from'] ?? 0); ?> to <?php echo e($meta['to'] ?? 0); ?> of <?php echo e($meta['total'] ?? 0); ?> results
                    </div>
                    <div class="flex items-center space-x-2">
                        <?php if($meta['current_page'] > 1): ?>
                            <button @click="navigateToPage(<?php echo e($meta['current_page'] - 1); ?>)" 
                                    class="px-3 py-1 text-sm border border-gray-300 rounded-md hover:bg-gray-50">
                                Previous
                            </button>
                        <?php endif; ?>
                        
                        <?php for($i = max(1, $meta['current_page'] - 2); $i <= min($meta['last_page'], $meta['current_page'] + 2); $i++): ?>
                            <button @click="navigateToPage(<?php echo e($i); ?>)" 
                                    class="px-3 py-1 text-sm border border-gray-300 rounded-md <?php echo e($i === $meta['current_page'] ? 'bg-blue-600 text-white' : 'hover:bg-gray-50'); ?>">
                                <?php echo e($i); ?>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('taskManagement', () => ({
        filters: {
            project_id: '<?php echo e($filters['project_id'] ?? ''); ?>',
            status: '<?php echo e($filters['status'] ?? ''); ?>',
            priority: '<?php echo e($filters['priority'] ?? ''); ?>',
            assignee_id: '<?php echo e($filters['assignee_id'] ?? ''); ?>',
        ...
        selectAll() {
            this.selectedTasks = <?php echo json_encode($tasks->pluck('id')->toArray(), 15, 512) ?>;
        ...
        async executeBulkAction() {
            ...
            try {
                const response = await fetch('<?php echo e(route('app.tasks.bulk-action')); ?>', {
                    method: 'POST',
                    headers: {
