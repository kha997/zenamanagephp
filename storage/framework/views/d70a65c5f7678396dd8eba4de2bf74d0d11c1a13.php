        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="/admin" class="bg-gray-600 hover:bg-gray-700 text-white font-medium py-2 px-4 rounded-lg transition duration-200">
                    <i class="fas fa-arrow-left mr-2"></i><?php echo e(__('settings.back_to_admin')); ?>
...
<?php echo $__env->make('layouts.app-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/settings/index.blade.php ENDPATH**/ ?>