<?php $__env->startSection('title', 'Template Library'); ?>
            ...
            <div class="py-6">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <a href="<?php echo e(route('templates.builder')); ?>" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="category" id="category" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            ...
                            <option value="project" <?php echo e(request('category') === 'project' ? 'selected' : ''); ?>>Project</option>
                            <option value="task" <?php echo e(request('category') === 'task' ? 'selected' : ''); ?>>Task</option>
                            <option value="workflow" <?php echo e(request('category') === 'workflow' ? 'selected' : ''); ?>>Workflow</option>
                            <option value="document" <?php echo e(request('category') === 'document' ? 'selected' : ''); ?>>Document</option>
                            <option value="report" <?php echo e(request('category') === 'report' ? 'selected' : ''); ?>>Report</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="sort" id="sort" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                            ...
                            <option value="recent" <?php echo e(request('sort') === 'recent' ? 'selected' : ''); ?>>Most Recent</option>
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                            <div class="p-6">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                        <h4 class="text-lg font-medium text-gray-900 mb-2"><?php echo e($template->name); ?></h4>
                                        ...
                                        <div class="flex items-center text-sm text-gray-500 mb-4">
                                            ...
                                            <?php echo e($template->usage_count); ?> uses
                                        </div>
                                        
                                        <div class="text-sm text-gray-500">
                                            Created by <?php echo e($template->creator->name ?? 'Unknown'); ?>
                                ...
                                <div class="mt-4 flex space-x-2">
                                    <button @click="viewTemplate('<?php echo e($template->id); ?>')" 
                                    ...
                                    <button @click="duplicateTemplate('<?php echo e($template->id); ?>')" 
        ...
        <div class="bg-white shadow rounded-lg">
            ...
            <?php if($userTemplates->count() > 0): ?>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                    <?php $__currentLoopData = $userTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
                            <div class="p-6">
                                <div class="flex items-start justify-between">
                                    <div class="flex-1">
                                ...
                                <div class="mt-4 flex space-x-2">
                                    ...
                                    <button @click="editTemplate('<?php echo e($template->id); ?>')" 
                                            class="flex-1 inline-flex justify-center items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                        Edit
                                    </button>
                                    <button @click="duplicateTemplate('<?php echo e($template->id); ?>')" 
...
<?php echo $__env->make('layouts.app-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/app/templates/library.blade.php ENDPATH**/ ?>