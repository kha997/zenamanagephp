<?php $__env->startSection('title', 'Smart Documents Dashboard'); ?>
        ...
        <div x-data="smartDocumentsDashboard()">
                ...
                <div class="dashboard-card metric-card blue p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white" x-text="stats?.totalDocuments || <?php echo e($mockDocuments->count()); ?>"></p>
                            <p class="text-white/80 text-sm">
                                <span x-text="stats?.approvedDocuments || <?php echo e($mockDocuments->where('status', 'approved')->count()); ?>"></span> approved
                            </p>
                        </div>
                ...
                <div class="dashboard-card metric-card green p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white" x-text="stats?.pendingDocuments || <?php echo e($mockDocuments->where('status', 'pending')->count()); ?>"></p>
                            <p class="text-white/80 text-sm">
            ...
            <div class="dashboard-card p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <select class="zena-select" x-model="categoryFilter" @change="filterDocuments()">
                        <?php $__currentLoopData = $fileCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <select class="zena-select" x-model="typeFilter" @change="filterDocuments()">
                        <?php $__currentLoopData = $fileTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($key); ?>"><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                <div class="dashboard-card p-6">
                    ...
                    <div class="space-y-4">
                        <?php $__empty_1 = true; $__currentLoopData = $mockDocuments->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 rounded-lg flex items-center justify-center" 
                                     style="background-color: <?php echo e($document['file_type'] === 'pdf' ? '#ef4444' : ($document['file_type'] === 'docx' ? '#2563eb' : ($document['file_type'] === 'xlsx' ? '#16a34a' : ($document['file_type'] === 'figma' ? '#8b5cf6' : '#6b7280')))); ?>20">
                                    <?php
                                        $fileIcons = [
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600"><?php echo e($document['file_size']); ?> • <?php echo e(\Carbon\Carbon::parse($document['uploaded_at'])->format('M d, Y')); ?></p>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm font-medium text-gray-900"><?php echo e($document['download_count']); ?></span>
                            </div>
                        </div>
            ...
            <div class="dashboard-card p-6">
                ...
                <div x-show="viewMode === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <?php $__empty_1 = true; $__currentLoopData = $mockDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer"
                         @click="toggleDocumentSelection('<?php echo e($document['id']); ?>')"
                         :class="{ 'ring-2 ring-blue-500': selectedDocuments.includes('<?php echo e($document['id']); ?>') }">
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <div class="flex items-center space-x-1">
                                <input type="checkbox" 
                                       ...
                                       :checked="selectedDocuments.includes('<?php echo e($document['id']); ?>')"
                                       @click.stop="toggleDocumentSelection('<?php echo e($document['id']); ?>')">
                            </div>
                        </div>
                        
                        <div class="space-y-2">
                            <h4 class="font-medium text-gray-900 text-sm line-clamp-2"><?php echo e($document['name']); ?></h4>
                            <p class="text-xs text-gray-500"><?php echo e($document['file_size']); ?></p>
                            <div class="flex items-center justify-between">
                                <span class="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
                                    <?php echo e(ucfirst($document['category'])); ?>

                                </span>
                                <span class="text-xs text-gray-500">v<?php echo e($document['version']); ?></span>
                            </div>
                            <div class="flex items-center justify-between text-xs text-gray-500">
                                <span><?php echo e($document['download_count']); ?> downloads</span>
                                <span><?php echo e(\Carbon\Carbon::parse($document['uploaded_at'])->format('M d')); ?></span>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            ...
                            <tr>
                                <th class="w-12">
                                    <input type="checkbox" 
                                           ...
                                           :checked="selectedDocuments.length === <?php echo e($mockDocuments->count()); ?>">
                                </th>
                                <th>Document Name</th>
                                <th>Type</th>
                                <th>Category</th>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td>
                                    <input type="checkbox" 
                                           class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                           :checked="selectedDocuments.includes('<?php echo e($document['id']); ?>')"
                                           @change="toggleDocumentSelection('<?php echo e($document['id']); ?>')">
                                </td>
                                <td>
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <div class="font-medium text-gray-900"><?php echo e($document['name']); ?></div>
                                ...
                                <td class="text-sm text-gray-600"><?php echo e($document['project_name']); ?></td>
                                <td class="text-sm text-gray-600"><?php echo e($document['uploaded_by']); ?></td>
                                <td class="text-sm text-gray-600"><?php echo e(\Carbon\Carbon::parse($document['uploaded_at'])->format('M d, Y')); ?></td>
                                <td class="text-sm font-medium text-gray-900"><?php echo e($document['download_count']); ?></td>
                                <td>
                                    <div class="flex items-center space-x-2">
                                        <button class="zena-btn zena-btn-outline zena-btn-sm" title="Download" @click.stop="downloadDocument('<?php echo e($document['id']); ?>')">
                                            <i class="fas fa-download"></i>
                                        </button>
                                        <button class="zena-btn zena-btn-outline zena-btn-sm" title="Preview" @click.stop="previewDocument('<?php echo e($document['id']); ?>')">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <?php if($document['status'] === 'pending'): ?>
                                        <button class="zena-btn zena-btn-outline zena-btn-sm zena-btn-success" title="Approve" @click.stop="approveDocument('<?php echo e($document['id']); ?>')">
                                            <i class="fas fa-check"></i>
                                        </button>
                                        <button class="zena-btn zena-btn-outline zena-btn-sm zena-btn-danger" title="Reject" @click.stop="rejectDocument('<?php echo e($document['id']); ?>')">
                                            <i class="fas fa-times"></i>
                                        </button>
                                        <?php endif; ?>
                                        <button class="zena-btn zena-btn-outline zena-btn-sm zena-btn-danger" title="Delete" @click.stop="deleteDocument('<?php echo e($document['id']); ?>')">
                ...
                <div class="mt-6 flex items-center justify-between">
                    <div class="flex items-center text-sm text-gray-700">
                        ...
                        <span>of <span class="font-medium"><?php echo e($mockDocuments->count()); ?></span> documents</span>
                    </div>
...
function smartDocumentsDashboard() {
    return {
        ...
        // Stats
        stats: {
            totalDocuments: <?php echo e($mockDocuments->count()); ?>,
            approvedDocuments: <?php echo e($mockDocuments->where('status', 'approved')->count()); ?>,
            pendingDocuments: <?php echo e($mockDocuments->where('status', 'pending')->count()); ?>,
            rejectedDocuments: <?php echo e($mockDocuments->where('status', 'rejected')->count()); ?>,
            uploadedThisWeek: 3,
            storageUsed: '23.8',
            totalDownloads: 81,
            fileTypes: 8,
        ...
        toggleAllDocuments() {
            if (this.selectedDocuments.length === <?php echo e($mockDocuments->count()); ?>) {
                this.selectedDocuments = [];
            } else {
                // Select all documents
                this.selectedDocuments = <?php echo json_encode($mockDocuments->pluck('id')->toArray(), 15, 512) ?>;
            }
        },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/documents/index.blade.php ENDPATH**/ ?>