...
<body class="bg-gray-50">
    ...
    <script>
        window.mockAuth = {
            user: <?php echo json_encode($mockAdminUser, 15, 512) ?>,
            tenant: null
        };
    </script>
    ...
    <div class="min-h-screen">
        ...
        <div class="demo-content">
            ...
            <div id="dashboard-demo" class="demo-panel">
                <?php echo $__env->make('admin.dashboard-new', [
            ...
            <div id="users-demo" class="demo-panel hidden">
                <?php echo $__env->make('admin.users.index-new', [
                    'users' => $mockUsers,
                    'tenants' => $mockTenants
                ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            ...
            <div id="tenants-demo" class="demo-panel hidden">
                <?php echo $__env->make('admin.tenants.index-new', [
                    'tenants' => $mockTenants
                ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/_demos/admin-demo.blade.php ENDPATH**/ ?>