...
document.addEventListener('DOMContentLoaded', function() {
    const tenantId = '<?php echo e($id); ?>';
    const tenantDetail = new TenantDetailPage(tenantId);
    tenantDetail.init();
});
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/zenamanage/resources/views/admin/tenants/show.blade.php ENDPATH**/ ?>