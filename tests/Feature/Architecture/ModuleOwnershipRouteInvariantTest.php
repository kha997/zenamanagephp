...
class ModuleOwnershipRouteInvariantTest extends TestCase
{
    public function test_zena_business_modules_stay_owned_by_app_api_controllers(): void
    {
        $expected = [
            ...
            'api.zena.materials.index' => 'App\\Http\\Controllers\\Api\\MaterialController',
            'api.zena.materials.show' => 'App\\Http\\Controllers\\Api\\MaterialController',
            ...
            'api.zena.vendors.index' => 'App\\Http\\Controllers\\Api\\VendorController',
            'api.zena.vendors.show' => 'App\\Http\\Controllers\\Api\\VendorController',
